...
export default function Shader(vertexSource, fragmentSource) {
    ...
    // 矩阵说明
    /*
        gl_NormalMatrix 法向量变换矩阵

        gl_ModelViewMatrix 模型视图矩阵
        gl_ProjectionMatrix 投影矩阵
        gl_ModelViewProjectionMatrix 模型视图投影矩阵

        gl_ModelViewMatrixInverse 模型视图逆矩阵
        gl_ProjectionMatrixInverse 投影逆矩阵
        gl_ModelViewProjectionMatrixInverse 模型视图投影逆矩阵
     */
    var header = '\
